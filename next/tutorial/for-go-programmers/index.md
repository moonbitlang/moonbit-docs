...
[`Unit`](../../language/fundamentals/builtins-and-literals.md#unit)
, [`Boolean`](../../language/fundamentals/builtins-and-literals.md#boolean)
, integers ([`Int`](../../language/fundamentals/builtins-and-literals.md#number), [`Int64`](../../language/fundamentals/builtins-and-literals.md#number), [`UInt`](../../language/fundamentals/builtins-and-literals.md#number), etc.)
, floating-point numbers ([`Double`](../../language/fundamentals/builtins-and-literals.md#number), [`Float`](../../language/fundamentals/builtins-and-literals.md#number), etc.)
, [`String`](../../language/fundamentals/builtins-and-literals.md#string)
, [`Char`](../../language/fundamentals/builtins-and-literals.md#char)
, [`Byte`](../../language/fundamentals/builtins-and-literals.md#bytes).

Notable **immutable collection types** in MoonBit include
[tuples](../../language/fundamentals/builtins-and-literals.md#tuple),
...
mutable collections such as [`Array[T]`](../../language/fundamentals/builtins-and-literals.md#array)
, [`FixedArray[T]`](../../language/fundamentals/builtins-and-literals.md#array)
, and [`Map[K, V]`](../../language/fundamentals/builtins-and-literals.md#map),
...
#### The [`Ref[T]`](../../language/fundamentals/builtins-and-literals.md#ref) Helper Type

When you need explicit mutable references to value types,
MoonBit provides the [`Ref[T]`](../../language/fundamentals/builtins-and-literals.md#ref) type

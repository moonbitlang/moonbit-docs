...
Besides pattern matching, you can also use `.inner()` to extract the internal representation of newtypes.
`.inner()` is a [method](/language/methods.md) automatically generated by MoonBit for every newtype:

...
```{literalinclude} /sources/error_codes/4073_error/a/top.mbt
:language: moonbit
```
...
```{literalinclude} /sources/error_codes/4073_error/top.mbt
:language: moonbit
```
...
```{literalinclude} /sources/error_codes/4073_fixed/top.mbt
:language: moonbit
```

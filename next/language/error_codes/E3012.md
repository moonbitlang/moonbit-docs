...
```{literalinclude} /sources/error_codes/3012_error/top.mbt
:language: moonbit
```
...
```{literalinclude} /sources/error_codes/3012_fixed/top.mbt
:language: moonbit
```

Or,

```{literalinclude} /sources/error_codes/3012_fixed/top_1.mbt
:language: moonbit
```

...
a higher-order function that takes an operation.

`IterResult` is an enum object that tracks the state of current iteration which consists any of the 2 states:

...
[Formal Verification](https://docs.moonbitlang.com/en/latest/language/verification.html), especially
[Contracts in `.mbt`](https://docs.moonbitlang.com/en/latest/language/verification.html#contracts-in-mbt) and
[Loop Invariants](https://docs.moonbitlang.com/en/latest/language/verification.html#loop-invariants).

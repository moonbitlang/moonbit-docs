...
In other cases, you can create the map using the `Map::from_array` function. It takes an array of two-element tuples, where the first element is the key and the second element is the value.
